...
This project was developed with [Claude Code](https://claude.ai/claude-code) (Anthropic). The asteroids app uses NASA's [Near Earth Object Web Service (NeoWs)](https://api.nasa.gov/) and the [JPL Small Body Database API](https://ssd-api.jpl.nasa.gov/doc/sbdb.html) for live orbital data. MINT Access is a Swiss non-profit organisation promoting accessible science and mathematics education — website at [mintaccess.ch](https://www.mintaccess.ch/) (German).
