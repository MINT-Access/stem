...
(* ================================================================
   ...
   Runs all 26 apps with their most compelling presets, collects
...
If[!$checkOnly,
  ...
  dl["which exercises all 26 STEM apps with their most scientifically and"];
  ...
  dl["15. **thermo** \[LongDash] `distribution_audio.wav`"];
  ...
  dl["16. **montecarlo** \[LongDash] `sweep_audio.wav`"];
  ...
  dl["17. **magnetic** \[LongDash] `mirror_audio.wav`"];
  ...
  dl["18. **lorenz** \[LongDash] `rossler_audio.wav`"];
  ...
  dl["19. **dynamical** \[LongDash] `sweep_audio.wav`"];
  ...
  dl["20. **henon** \[LongDash] `henon_attractor.wav`"];
  ...
  dl["23. **resonance** \[LongDash] `galilean_audio.wav`"];
  ...
  dl["   Ganymede note."]; dl[""];
  dl["24. **images** \[LongDash] `images_brightness_audio.wav`"];
  ...
  dl["25. **relativity** \[LongDash] `chirp.wav`"];
  ...
  dl["26. **cosmology** \[LongDash] `cmb_spectrum_audio.wav`"];
