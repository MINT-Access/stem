...
$demoApps = {
  ...
  <|
    "name"      -> "grover",
    "preset"    -> "compare mode, N=64, binaural classical vs quantum race",
    "cliArgs"   -> {"main.wl", "--", "--simulation.mode=compare"},
    "expected"  -> {"output/grover_compare.wav",
                    "output/grover_compare.gif",
                    "output/grover_compare.png",
                    "output/grover_compare.csv"},
    "listenFor" -> "grover_compare.wav \[LongDash] a binaural race: left channel ticks through " <>
                   "an average-case classical search (32 queries), right channel ticks through " <>
                   "Grover's algorithm (6 queries) \[LongDash] both start together, and the " <>
                   "right channel's \"found\" chime rings out long before the left channel " <>
                   "finishes, the quantum speedup made literally audible as a difference in time"
  |>,
  <|
    "name"      -> "hydrogen",
  ...
  |>,
  <|
    "name"      -> "quantum_statistics",
    "preset"    -> "fermi_sea mode, T-0 step function sharpening to blurring",
    "cliArgs"   -> {"main.wl", "--", "--simulation.mode=fermi_sea"},
    "expected"  -> {"output/quantum_statistics_fermi_sea.wav",
                    "output/quantum_statistics_fermi_sea.gif",
                    "output/quantum_statistics_fermi_sea.png",
                    "output/quantum_statistics_fermi_sea.csv"},
    "listenFor" -> "quantum_statistics_fermi_sea.wav \[LongDash] the textbook Fermi-Dirac step " <>
                   "function, one chord per temperature: a bright, sharply-defined texture at " <>
                   "the coldest step, softening into a duller, more even wash of sound as " <>
                   "temperature rises and the step blurs \[LongDash] from thermo/'s classical " <>
                   "Maxwell-Boltzmann gas to the deeper quantum statistics it is a limiting " <>
                   "case of"
  |>,
  <|
    "name"      -> "montecarlo",
...
If[!$checkOnly,
  ...
  dl["11. **grover** \[LongDash] `grover_compare.wav`"];
  dl["   From two entangled qubits to a genuine quantum algorithm: a binaural race."];
  dl["   Left channel ticks through a classical linear search, right channel ticks"];
  dl["   through Grover's algorithm \[LongDash] both start together, and the right"];
  dl["   channel's \"found\" chime rings out long before the left channel finishes,"];
  dl["   the quantum speedup made literally audible as a difference in time."]; dl[""];
  dl["12. **scattering** \[LongDash] `discovery_audio.wav`"];
  ...
  dl["13. **hydrogen** \[LongDash] `spectrum_audio.wav`"];
  ...
  dl["   to infrared."]; dl[""];
  dl["14. **blackbody** \[LongDash] `spectrum_audio.wav`"];
  ...
  dl["15. **compton** \[LongDash] `discovery_audio.wav`"];
  ...
  dl["16. **quantum_tunnelling** \[LongDash] `barrier_audio.wav`"];
  ...
  dl["17. **clt** \[LongDash] `dice_audio.wav`"];
  ...
  dl["18. **brownian** \[LongDash] `brownian_ensemble.wav`"];
  ...
  dl["   are real."]; dl[""];
  dl["19. **thermo** \[LongDash] `distribution_audio.wav`"];
  ...
  dl["20. **quantum_statistics** \[LongDash] `quantum_statistics_fermi_sea.wav`"];
  dl["   From a classical gas to the deeper quantum statistics it is a limiting"];
  dl["   case of: the Fermi-Dirac step function, one chord per temperature. Hear a"];
  dl["   bright, sharply-defined texture at the coldest step soften into a duller,"];
  dl["   more even wash of sound as temperature rises and the step blurs."]; dl[""];
  dl["21. **montecarlo** \[LongDash] `sweep_audio.wav`"];
  ...
  dl["22. **magnetic** \[LongDash] `mirror_audio.wav`"];
  ...
  dl["23. **lorenz** \[LongDash] `rossler_audio.wav`"];
  ...
  dl["24. **dynamical** \[LongDash] `sweep_audio.wav`"];
  ...
  dl["25. **henon** \[LongDash] `henon_attractor.wav`"];
  ...
  dl["28. **resonance** \[LongDash] `galilean_audio.wav`"];
  ...
  dl["   Ganymede note."]; dl[""];
  dl["29. **images** \[LongDash] `images_brightness_audio.wav`"];
  ...
  dl["afplay demo/grover/output/grover_compare.wav"];
  ...
  dl["afplay demo/quantum_statistics/output/quantum_statistics_fermi_sea.wav"];
