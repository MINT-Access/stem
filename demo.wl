...
(* ================================================================
   ...
   Runs all 24 apps with their most compelling presets, collects
...
If[!$checkOnly,
  ...
  dl["which exercises all 24 STEM apps with their most scientifically and"];
  ...
  dl["14. **thermo** \[LongDash] `distribution_audio.wav`"];
  dl["   From one barrier-crossing event to the statistics of many classical"];
  ...
  dl["15. **montecarlo** \[LongDash] `sweep_audio.wav`"];
  ...
  dl["16. **magnetic** \[LongDash] `mirror_audio.wav`"];
  ...
  dl["17. **lorenz** \[LongDash] `rossler_audio.wav`"];
  ...
  dl["18. **dynamical** \[LongDash] `sweep_audio.wav`"];
  ...
  dl["21. **resonance** \[LongDash] `galilean_audio.wav`"];
  ...
  dl["   Ganymede note."]; dl[""];
  dl["22. **images** \[LongDash] `images_brightness_audio.wav`"];
  ...
  dl["23. **relativity** \[LongDash] `chirp.wav`"];
  ...
  dl["24. **cosmology** \[LongDash] `cmb_spectrum_audio.wav`"];
